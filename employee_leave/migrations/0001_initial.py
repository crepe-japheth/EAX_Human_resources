    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('it_and_market_data', 'IT and Market Data'), ('commercial', 'Commercial'), ('HR', 'Human Resources (HR)'), ('trading', 'Trading'), ('quality', 'Quality'), ('administration', 'Administration')], max_length=200, null=True)),
                ('rssb_id', models.CharField(max_length=200, null=True)),
                ('allowed_leave', models.IntegerField(blank=True, default=10, null=True)),
